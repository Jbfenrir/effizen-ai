// SCRIPTS INDIVIDUELS - À exécuter UN PAR UN dans la console
...
// ÉTAPE 2 : Lot 1
const injectLot1 = async () => {
  if (!window.userData) {
    console.error('❌ Exécutez d\'abord initInjection()');
    return;
  }
  
  console.log('🔄 Injection lot 1/5...');
  
  const lot = [
  {
    "id": "entry_2025_08_11_t2ci",
    "user_id": window.userData.user.id,
  ...
  console.log('📥 Lot 1 : ' + newEntries.length + ' nouvelles entrées');
  ...
  if (error) {
    ...
    console.log('✅ Lot 1 injecté ! Total : ' + window.userData.totalInjected + '/23');
    
    if (1 === 5) {
      console.log('🎉 INJECTION TERMINÉE ! Rechargez la page.');
    } else {
      console.log('➡️  Exécutez maintenant : injectLot2()');
    }
  }
};
...
// ÉTAPE 3 : Lot 2
const injectLot2 = async () => {
  if (!window.userData) {
    console.error('❌ Exécutez d\'abord initInjection()');
    return;
  }
  
  console.log('🔄 Injection lot 2/5...');
  ...
  console.log('📥 Lot 2 : ' + newEntries.length + ' nouvelles entrées');
  ...
  if (error) {
    ...
    window.userData.totalInjected += newEntries.length;
    newEntries.forEach(entry => window.userData.existingDates.add(entry.entry_date));
    console.log('✅ Lot 2 injecté ! Total : ' + window.userData.totalInjected + '/23');
    
    if (2 === 5) {
      console.log('🎉 INJECTION TERMINÉE ! Rechargez la page.');
    } else {
      console.log('➡️  Exécutez maintenant : injectLot3()');
    }
  }
};
...
// ÉTAPE 4 : Lot 3
const injectLot3 = async () => {
  if (!window.userData) {
    console.error('❌ Exécutez d\'abord initInjection()');
    return;
  }
  
  console.log('🔄 Injection lot 3/5...');
  ...
  console.log('📥 Lot 3 : ' + newEntries.length + ' nouvelles entrées');
  ...
  if (error) {
    ...
    window.userData.totalInjected += newEntries.length;
    newEntries.forEach(entry => window.userData.existingDates.add(entry.entry_date));
    console.log('✅ Lot 3 injecté ! Total : ' + window.userData.totalInjected + '/23');
    
    if (3 === 5) {
      console.log('🎉 INJECTION TERMINÉE ! Rechargez la page.');
    } else {
      console.log('➡️  Exécutez maintenant : injectLot4()');
    }
  }
};
...
// ÉTAPE 5 : Lot 4
const injectLot4 = async () => {
  if (!window.userData) {
    console.error('❌ Exécutez d\'abord initInjection()');
    return;
  }
  
  console.log('🔄 Injection lot 4/5...');
  ...
  console.log('📥 Lot 4 : ' + newEntries.length + ' nouvelles entrées');
  ...
  if (error) {
    ...
    window.userData.totalInjected += newEntries.length;
    newEntries.forEach(entry => window.userData.existingDates.add(entry.entry_date));
    console.log('✅ Lot 4 injecté ! Total : ' + window.userData.totalInjected + '/23');
    
    if (4 === 5) {
      console.log('🎉 INJECTION TERMINÉE ! Rechargez la page.');
    } else {
      console.log('➡️  Exécutez maintenant : injectLot5()');
    }
  }
};
...
// ÉTAPE 6 : Lot 5
const injectLot5 = async () => {
  if (!window.userData) {
    console.error('❌ Exécutez d\'abord initInjection()');
    return;
  }
  
  console.log('🔄 Injection lot 5/5...');
  ...
  console.log('📥 Lot 5 : ' + newEntries.length + ' nouvelles entrées');
  ...
  if (error) {
    ...
    window.userData.totalInjected += newEntries.length;
    newEntries.forEach(entry => window.userData.existingDates.add(entry.entry_date));
    console.log('✅ Lot 5 injecté ! Total : ' + window.userData.totalInjected + '/23');
    
    if (5 === 5) {
      console.log('🎉 INJECTION TERMINÉE ! Rechargez la page.');
    } else {
      console.log('➡️  Exécutez maintenant : injectLot6()');
    }
  }
};
